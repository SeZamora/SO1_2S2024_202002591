...
func enviarMensajeKafka(producer *kafka.Producer, topic string, mensaje []byte) error {
	...
	if remainingMessages > 0 {
		log.Printf("Natacion No se pudieron enviar todos los mensajes. Mensajes restantes: %d", remainingMessages)
		return fmt.Errorf("Natacion No se pudieron enviar todos los mensajes. Mensajes restantes: %d", remainingMessages)
	}
...
func main() {
	...
	log.Printf("Servidor de Natacion escuchando en el puerto 50052")
